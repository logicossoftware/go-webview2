...
func _ICoreWebView2EstimatedEndTimeChangedEventHandlerInvoke(this *ICoreWebView2EstimatedEndTimeChangedEventHandler, sender *ICoreWebView2DownloadOperation, args uintptr) uintptr {
	return this.impl.EstimatedEndTimeChanged(sender, args)
}

type _ICoreWebView2EstimatedEndTimeChangedEventHandlerImpl interface {
	_IUnknownImpl
	EstimatedEndTimeChanged(sender *ICoreWebView2DownloadOperation, args uintptr) uintptr
}
